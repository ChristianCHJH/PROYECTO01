...
<div class="container-fluid">
    <div class="row" style="margin-bottom: 15px;margin-left: 20px;margin-right: 20px;">
        ...
        <div class="col-md-4" >
                ...
                <section class="shadow p-3 rounded" style="margin-bottom: 15px;margin-left: 0px;margin-right: 0px; background-color: #{{$fondo_section}};">
                    <form id="actualizarReq" action="{{route('requerimiento.update',$requerimiento)}}" method="POST">
                        ...
                        <?php if ($requerimiento->asignacion == null && $requerimiento->htcategorias_id == null) { ?>
                            @can('requerimiento.ticket.button.asignar')
                                <div class="row">
                                    <div class="col">
                            ...
                            @endcan
                        <?php }else { ?>
                            @can('requerimiento.ticket.button.actualizar.asignar')
                                <div class="row">
                                    <div class="col">
                            ...
                            <section class=" p-3 rounded" style="margin-bottom: 15px;margin-left: 0px;margin-right: 0px; background-color: #{{$fondo_section}};">
                                ...
                                <form action="{{route('SolicServ.store',$requerimiento)}}" method="POST">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputGroupSelect01" style="border-radius: 10rem 0 0 10rem;">MONEDA</label>
                                        </div>
                                        <select class="custom-select" id="tipo_moneda" name="tipo_moneda">
                                        <option value="" selected>Seleccione moneda</option>
                                        <option value="Soles">Soles <strong>S/.</strong></option>
                                        <option value="Dolar">Dolar <strong>$.</strong></option>
                                        </select>
                                    </div>

                                    @can('requerimiento.ticket.costo')
                                        <!-- COSTO -->
                                            <div class="input-group mb-3" >
                                                <div class="input-group-prepend">
                                    ...
                                    @can('requerimiento.ticket.precio')
                                        <!-- PRECIO -->
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                    ...
                                    @can('requerimiento.ticket.button.crear')
                                        <div class="row">
                                            <div class="col">
                                ...
                                <form action="{{route('SolicServ.update',$solicitudservreque)}}" method="POST">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="tipo_moneda" name="tipo_moneda">
                                            ...
                                            <?php if ($solicitudservreques[0]->tipo_moneda == "Soles") { ?>
                                                <option value="Soles" selected>Soles <strong>S/.</strong></option>
                                                <option value="Dolar">Dolar <strong>$.</strong></option>
                                            <?php }elseif ($solicitudservreques[0]->tipo_moneda == "Dolar") { ?>
                                                <option value="Soles">Soles <strong>S/.</strong></option>
                                                <option value="Dolar" selected>Dolar <strong>$.</strong></option>
                                            <?php } ?>
                                        ...
                                        <!-- COSTO -->
                                            <div class="input-group mb-3" >
                                                ...
                                                <?php }elseif ($solicitudservreques[0]->tipo_moneda == "Dolar") { ?>
                                                    ...
                                                    <input type="number" class="form-control" style="text-align: right" id="costo" name="costo" value={{$solicitudservreques[0]->costoDolar}}>
                                    ...
                                    @can('requerimiento.ticket.precio')
                                        <!-- PRECIO -->
                                            <div class="input-group mb-3">
                                                ...
                                                <?php if ($solicitubienes[0]->tipo_moneda == "Soles") { ?>
                                                    
                                                    <input type="number" class="form-control" style="text-align: right" id="precio" name="precio" value={{$solicitudservreques[0]->precio}}>

                                                <?php }elseif ($solicitubienes[0]->tipo_moneda == "Dolar") { ?>
                                                    
                                                    <input type="number" class="form-control" style="text-align: right" id="precio" name="precio" value={{$solicitudservreques[0]->precioDolar}}>
                                ...
                                <!-- COSTO -->
                                    <div class="input-group mb-3" >
                                        ...
                                        <?php }elseif ($solicitubienes[0]->tipo_moneda == "Dolar") { ?>
                                            ...
                                            <input type="number" class="form-control" style="text-align: right" id="costoMaterial" name="costoMaterial" value={{$solicitubienes[0]->costoDolar}}>
                                ...
                                <!-- PRECIO -->
                                    <div class="input-group mb-3">
                                        ...
                                        <?php }elseif ($solicitubienes[0]->tipo_moneda == "Dolar") { ?>
                                            ...
                                            <input type="number" class="form-control" style="text-align: right" id="precio" name="precio" value={{$solicitubienes[0]->precioDolar}}>
            ...
            <!-- APROVACIONES BIENES Y MATERIALES-->
                @foreach ($solicitubienes as $validBieneAprov)

                    <!-- VALIDACION APROBACION BIENES Y MATERIALES-->
                                ...
                                <div class="direct-chat-messages" style="height: 245px;">
                                        ...
                                        <form>
                                            ...
                                            <div class="col" style="text-align: center;">
                                                ...
                                                <?php if ($validBieneAprov->AprobacionADM == "pendiente") { ?>
                    ...
                    <!-- FIN VALIDACION APROBACION BIENES Y MATERIALES-->

                @endforeach
            <!-- FIN APROVACIONES BIENES Y MATERIALES-->


            <!-- APROVACIONES SOLICITUD DE SERVICIO-->
                @foreach ($solicitudservreques as $solicitudservreque)

                    <!-- VALIDACION APROBACION SOLICITUD DE SERVICIO-->
                        <div class="card card-danger direct-chat direct-chat-danger collapsed-card">
                            <div class="card-header" style="background-color: #{{$boton_NUE_COMEN}}; color: #ffffff;">
                            ...
                            <div class="card-body" style="background-color: #{{$NEWfondo_section}}; color: #{{$NEWcolortext}};">
                                ...
                                <div class="direct-chat-messages" style="height: 245px;">
                                    ...
                                    @can('requerimiento.ticket.aprobacion.administrador')
                                        ...
                                        <form>
                                            ...
                                            <div class="col" style="text-align: center;">
                                                ...
                                                <?php if ($solicitudservreque->AprobacionADM == "pendiente") { ?>

                                                    <a href="{{route('SolicServ.aproadmin',$solicitudservreque)}}"><button  type="button" class="btn" style="background-color: #8a8282; color: #{{$TEXT_boton_NUE_COMEN}};">PENDIENTE</button></a>
                                            
                                                <?php } ?>

                                                <?php if ($solicitudservreque->AprobacionADM == "aprobado") { ?>

                                                    <a href="{{route('SolicServ.aproadmin',$solicitudservreque)}}"><button  type="button" class="btn" style="background-color: #176807; color: #{{$TEXT_boton_NUE_COMEN}};">APROBADO</button></a>
                                                <?php } ?>
                                    ...
                                    @can('requerimiento.ticket.aprobacion.jefe.operaciones')
                                        <?php if ($solicitudservreque->costo > 200) { ?>
                                            ...
                                            <form>
                                                ...
                                                <div class="col" style="text-align: center;">
                                                    ...
                                                    <?php if ($solicitudservreque->AprobacionJOP == null || $solicitudservreque->AprobacionJOP == "pendiente") { ?>

                                                        <a href="{{route('SolicServ.aprojop',$solicitudservreque)}}"><button  type="button" class="btn" style="background-color: #8a8282; color: #{{$TEXT_boton_NUE_COMEN}};">PENDIENTE</button></a>
                                                
                                                    <?php } ?>

                                                    <?php if ($solicitudservreque->AprobacionJOP == "aprobado") { ?>

                                                        <a href="{{route('SolicServ.aprojop',$solicitudservreque)}}"><button  type="button" class="btn" style="background-color: #176807; color: #{{$TEXT_boton_NUE_COMEN}};">APROBADO</button></a>
                                                    <?php } ?>
                                    ...
                                    @can('requerimiento.ticket.aprobacion.gerente.general')
                                        <?php if ($solicitudservreque->costo > 1000) { ?>
                                            <form>
                                                <div class="form-row" style="margin-bottom: 20px;margin-top: 20px;">
                                                <div class="col"  style="text-align: center;align-items: center;">
                                                    <label for="exampleFormControlInput1">GERENTE GENERAL</label>
                                                ...
                                                <div class="col" style="text-align: center;">
                                                    ...
                                                    <?php if ($solicitudservreque->AprobacionGG == null || $solicitudservreque->AprobacionGG == "pendiente") { ?>

                                                        <a href="{{route('SolicServ.aprogg',$solicitudservreque)}}"><button  type="button" class="btn" style="background-color: #8a8282; color: #{{$TEXT_boton_NUE_COMEN}};">PENDIENTE</button></a>
                                                
                                                    <?php } ?>

                                                    <?php if ($solicitudservreque->AprobacionGG == "aprobado") { ?>

                                                        <a href="{{route('SolicServ.aprogg',$solicitudservreque)}}"><button  type="button" class="btn" style="background-color: #176807; color: #{{$TEXT_boton_NUE_COMEN}};">APROBADO</button></a>
                                                    <?php } ?>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" src="..{{$requerimiento->imagen}}" alt="First slide">
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body" style="background-color: #{{$bg_DESCRIPCION}}; color: #{{$bg_DESCRIPCION_text}};">
                                        ...
                                        <p class="card-text " style=" padding: 20px; padding-top: 0px;">{{$requerimiento->descripcion}}</p>
                                            ...
                                            <?php if ($requerimiento->imagen != null) { ?>
                                                ...
                                                <img class="card-img-bottom" data-toggle="modal" data-target="#imegenprincipalReq"  style="display: block; margin: auto; padding-bottom: 30px; width: 250PX;" src="..{{$requerimiento->imagen}}" alt="sin imagen">
                            ...
                            @foreach ($reqobservaciones as $reqobservacione)
                                    <div class="card bg-blue">
                                        <div class="card-header" style="background-color: #{{$bg_ASUNTO}}; color: #{{$bg_ASUNTO_text}};">
                                            ...
                                            @can('requerimiento.ticket.eliminar.comentario')
