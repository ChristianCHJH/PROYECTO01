...
@section('content')
    ...
    <!-- ACORDEON DE DOCUMENTOS -->
        @can('cuenta.documento.view.seccion')
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-3">
                                                            <?php if ($quote->pdfDoc == null) { ?>
                                                                Ningun documento cargado
                                                            <?php }else { ?>
                                                                <a href="..{{$quote->pdfDoc}}" target="blank_">Ver documento</a>
                                                            <?php } ?>
                                                        </div>
                                                        <div class="col-3">

                                                            @can('cuenta.documento.eliminar')
                                                                <a href="{{route('cotizacion.destroy', $quote)}}"><button type="button"  class="btn btn-danger" >L</button></a>
                                                            @endcan

                                                            @can('cuenta.documento.editar')
    ...
    <!-- ACORDEON DE DATOS DE CUENTA -->
        @can('cuenta.datoscuenta.view.seccion')
            <div class="accordion" id="accordionExample" style="margin-bottom: 15px;margin-left: 20px;margin-right: 20px;">
                <div class="card">
                                        ...
                                        <!-- INICIO SECCION DATOS DE EMPRESA -->
                                            <form>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="exampleFormControlSelect2">TIPO FACTURACION</label>
                                                        <input type="text" class="form-control" value="{{$cuenta ->tipoFacturacion}}" readonly>
                                                    </div>
    ...
    <!-- ACORDEON DE INTERLOCUTOR -->
        @can('cuenta.interlocutor.view.seccion')
            <div class="accordion" id="accordionExample" style="margin-bottom: 15px;margin-left: 20px;margin-right: 20px;">
                <div class="card">
                                            ...
                                            <?php if ($interlocutor ->cuenta_id == $cuenta ->id) { ?>
                                                ...
                                                <section class="p-3 bg-white rounded" style="margin-bottom: 15px;margin-left: 20px;margin-right: 20px;">
                                                    <div class="row">
                                                        ...
                                                        @can('cuenta.interlocutor.editar')
                                                            <div class="col-md-6" style="text-align: RIGHT;">
                                                                <form   action="{{route('interlocutors.destroy', $interlocutor->id)}}" method="POST">
                                                                    ...
                                                                    @can('cuenta.interlocutor.eliminar')
    ...
    <!-- ACORDEON COLABORADOR -->
        @can('cuenta.colaborador.view.seccion')
            <div class="accordion" id="accordionExample" style="margin-bottom: 15px;margin-left: 20px;margin-right: 20px;">
                <div class="card">
                        <div class="card" style="margin-bottom: 0px;">
                            <div class="card-header" id="headingTwo">
                                            ...
                                            <table class="table" style="margin-bottom: 0px;">
                                                <thead class="table table-striped table-dark">
                                                    <tr>
                                                        ...
                                                        @can('cuenta.colaborador.editar')
                                                            <th></th>
                                                        @endcan

                                                        @can('cuenta.colaborador.eliminar')
                                                            <th></th>
                                                        @endcan
                ...
                <table class="table">
                    <thead class="table table-striped table-dark">
                        <tr>
                            ...
                            @can('cuenta.sedes.editar')
                                <th></th>
                            @endcan

                            @can('cuenta.sedes.eliminar')
                                <th></th>
                            @endcan
                        ...
                        <form class="needs-validation" action="{{route('cuentas.update',$cuenta)}}" method="POST" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="tipoFacturacion" name="tipoFacturacion" required >
                                    ...
                                    <?php if ($cuenta->tipoFacturacion == "Precio flat fijo") { ?>
                                        <option value="Precio flat fijo" selected>Precio flat fijo</option>
                                        <option value="Precio variable" >Precio variable</option>
                                        <?php }elseif($cuenta->tipoFacturacion == "Precio variable") { ?>
                                        <option value="Precio flat fijo" >Precio flat fijo</option>
                                        <option value="Precio variable" selected>Precio variable</option>
                                    <?php } ?>
