                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                                ...
                                                <div class="carousel-item active">
                                                    <img class="d-block w-100" src="../{{$pamobservacione->imagen}}" alt="First slide">
                                                </div>
                                                </div>
                                            </div>
                                ...
                                @foreach ($pamobservaciones as $pamobservacione)
                                    <div class="card bg-blue">
                                        ...
                                        <?php if ($pamobservacione->imagen != null) { ?>
                                            ...
                                            <img class="card-img-bottom" data-toggle="modal" data-target="#exampleModal{{$pamobservacione->id}}"  style="display: block; margin: auto; padding-bottom: 30px; width: 250PX;" src="../{{$pamobservacione->imagen}}" alt="sin imagen">
                                        <?php } ?>
                                    </div>
