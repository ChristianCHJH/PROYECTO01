...
@section('content')
    ...
    <!-- ACORDEON Contingencia -->
        @can('htcuenta.contingencia.view.seccion')
                                                ...
                                                <table class="mx-auto table w-75" style="margin-bottom: 0px;">
                                                    <thead class="table table-striped table-dark">
                                                        <tr>
                                                            ...
                                                            @can('ht.contingencia.vista.columna.saldo')
                                                                <th scope="col">Saldo</th>
                                                            @endcan

                                                            @can('ht.contingencia.editar')
                                                                <th></th>
                                                            @endcan

                                                            @can('ht.contingencia.eliminar')
                                                                <th></th>
                                                            @endcan
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($contindiferidos as $contindiferido)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th style="width:400px">{{$contindiferido->partida}}</th>
            ...
            <table class="table">
                <thead class="table table-striped table-dark">
                    <tr>
                        ...
                        @can('ht.htestructura.vista.columna.costo')
                        ...
                        @can('ht.htestructura.vista.columna.precio')
                        ...
                        @can('ht.button.htestructura.show')
                            <td></td>
                        @endcan

                        @can('ht.htestructura.editar')
                            <td></td>
                        @endcan

                        @can('ht.htestructura.eliminar')
                            <td></td>
                        @endcan
                    </tr>
                </thead>
