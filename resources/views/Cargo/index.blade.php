...
<section class=" p-3 bg-white rounded" style="margin-bottom: 15px;margin-left: 20px;margin-right: 20px;">
    ...
    <div class="row">
        ...
        @can('categoria.cargos.nuevo')
            <div class="col-md-4">

                <section class="shadow p-3 rounded" style="margin-bottom: 15px;margin-left: 20px;margin-right: 20px;">

                    <h4 style="color: #{{$colortext}};"><strong>Añadir Cargo</strong></h4>
                    <br>

                    <form class=" needs-validation" action="{{route('cargo.store')}}" method="POST" novalidate>
                    ...
                    <table class="table">
                        <thead class="table table-striped table-dark">
                            <tr>
                                ...
                                @can('categoria.cargos.editar')
                                    <td></td>
                                @endcan
                                @can('categoria.cargos.eliminar')
                                    <td></td>
                                @endcan
                            </tr>
                        </thead>
                            ...
                            @foreach($cargos as $cargo)
                                <tr>
                                    ...
                                    @can('categoria.cargos.editar')
                                        ...
                                        <td align="center">
                                                <button type="button"  class="btn btn-warning" data-toggle="modal" data-target="#editCargo{{$cargo->id}}">
                                    ...
                                    <!-- MODAL EDITAR ESPECIALIDAD -->
                                        <div class="modal fade" id="editCargo{{$cargo->id}}" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="row needs-validation" action="{{route('cargo.update',$cargo)}}" method="POST" novalidate >
                                                            ...
                                                            <div class="form-group" style="color: #{{$colortext}};">
                                                                <label for="recipient-name" class="col-form-label">DESCRIPCION:</label>
                                                                <textarea class="form-control" id="descripcion" name="descripcion" rows="5">{{$cargo->descripcion}}</textarea>
                                                            </div>
