    ...
    <div class="row">
        ...
        @foreach ($documentssomas as $documentssoma)
            ...
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        @can('documentacion.ssoma.editar')
                        ...
                        <p class="card-text" style="margin-top: 20px;">{{$documentssoma->descripcion}}</p>
                                        ...
                                        <a href="..{{$documentssoma->pdf}}" target="blank_"><button type="button" class="btn btn-secondary float-right" style="margin-top: 15px; background-color: #{{$boton_crear}}; color: #{{$text_boton_crear}};"><strong>VER DOCUMENTO</strong></button></a>                                                                                            
                                
                                        @can('documentacion.ssoma.eliminar')
            ...
            @can('documentacion.ssoma.editar')
                ...
                <!-- FIN MODAL EDITAR NUEVO DOCUMENTO -->
            @endcan
...
@can('documentacion.ssoma.nuevo')
    <!-- MODAL REGISTRAR NUEVO DOCUMENTO -->
    ...
    <!-- FIN MODAL REGISTRAR NUEVO DOCUMENTO -->
@endcan
